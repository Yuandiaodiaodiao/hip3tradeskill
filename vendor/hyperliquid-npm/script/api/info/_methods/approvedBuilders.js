...
exports.ApprovedBuildersRequest = void 0;
exports.approvedBuilders = approvedBuilders;
 ...
 */
exports.ApprovedBuildersRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-approved-builders-for-user
 */
function approvedBuilders(config, params, signal) {
    const request = (0, _base_js_1.parse)(exports.ApprovedBuildersRequest, {
