...
exports.BorrowLendReserveStateRequest = void 0;
exports.borrowLendReserveState = borrowLendReserveState;
 ...
 */
exports.BorrowLendReserveStateRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-borrow-lend-reserve-state
 */
function borrowLendReserveState(config, params, signal) {
    const request = (0, _base_js_1.parse)(exports.BorrowLendReserveStateRequest, {
