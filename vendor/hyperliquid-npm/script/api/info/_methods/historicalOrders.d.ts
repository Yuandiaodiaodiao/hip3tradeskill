...
import type { FrontendOpenOrderSchema, OrderProcessingStatusSchema } from "./_base/commonSchemas.js";
/**
 * Request user historical orders.
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#retrieve-a-users-historical-orders
 */
export declare const HistoricalOrdersRequest: v.ObjectSchema<{
    /** Type of request. */
    readonly type: v.LiteralSchema<"historicalOrders", undefined>;
    /** User address. */
