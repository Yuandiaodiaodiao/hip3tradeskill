...
exports.BorrowLendUserStateRequest = void 0;
exports.borrowLendUserState = borrowLendUserState;
 ...
 */
exports.BorrowLendUserStateRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-borrow-lend-user-state
 */
function borrowLendUserState(config, params, signal) {
    const request = (0, _base_js_1.parse)(exports.BorrowLendUserStateRequest, {
