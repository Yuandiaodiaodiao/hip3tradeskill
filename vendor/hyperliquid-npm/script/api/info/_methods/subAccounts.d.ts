 ...
 */
export declare const SubAccountsRequest: v.ObjectSchema<{
    /** Type of request. */
    readonly type: v.LiteralSchema<"subAccounts", undefined>;
    /** User address. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#retrieve-a-users-subaccounts
 */
export declare function subAccounts(config: InfoConfig, params: SubAccountsParameters, signal?: AbortSignal): Promise<SubAccountsResponse>;
