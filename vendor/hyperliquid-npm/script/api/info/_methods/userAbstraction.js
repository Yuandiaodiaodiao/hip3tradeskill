...
exports.UserAbstractionRequest = void 0;
exports.userAbstraction = userAbstraction;
 ...
 */
exports.UserAbstractionRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-a-users-abstraction-state
 */
function userAbstraction(config, params, signal) {
    const request = (0, _base_js_1.parse)(exports.UserAbstractionRequest, {
