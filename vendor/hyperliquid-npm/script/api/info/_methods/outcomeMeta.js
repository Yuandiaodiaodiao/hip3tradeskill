...
exports.OutcomeMetaRequest = void 0;
exports.outcomeMeta = outcomeMeta;
 ...
 * @see null
 */
function outcomeMeta(config, signal) {
    const request = (0, _base_js_1.parse)(exports.OutcomeMetaRequest, {
        type: "outcomeMeta",
    });
