...
exports.UsdSendTypes = exports.UsdSendRequest = void 0;
...
const UsdSendParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UsdSendRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "time"]);
})();
...
function usdSend(config, params, opts) {
    const action = (0, _base_js_1.parse)(UsdSendParameters, params);
    return (0, execute_js_1.executeUserSignedAction)(config, { type: "usdSend", ...action }, exports.UsdSendTypes, opts);
}
