    ...
    return v.object({
        ...
        action: v.object({
            ...
            builder: v.optional(v.object({
                /** Builder address. */
                b: _schemas_js_1.Address,
                /** Builder fee in 0.1bps (1 = 0.0001%). Max 100 for perps (0.1%), 1000 for spot (1%). */
                f: v.pipe(_schemas_js_1.UnsignedInteger, v.maxValue(1000)),
            })),
        }),
...
const OrderParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.OrderRequest.entries.action.entries), ["type"]);
})();
/**
 * Place an order(s).
 *
...
function order(config, params, opts) {
    const action = (0, _base_js_1.parse)(OrderParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "order", ...action }, opts);
}
