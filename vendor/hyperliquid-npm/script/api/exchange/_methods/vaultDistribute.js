...
exports.VaultDistributeRequest = void 0;
exports.vaultDistribute = vaultDistribute;
 ...
 * @see null
 */
exports.VaultDistributeRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
             ...
             */
            usd: _schemas_js_1.UnsignedInteger,
        }),
...
const VaultDistributeParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.VaultDistributeRequest.entries.action.entries), ["type"]);
})();
/**
 * Distribute funds from a vault between followers.
 *
...
function vaultDistribute(config, params, opts) {
    const action = (0, _base_js_1.parse)(VaultDistributeParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "vaultDistribute", ...action }, opts);
}
