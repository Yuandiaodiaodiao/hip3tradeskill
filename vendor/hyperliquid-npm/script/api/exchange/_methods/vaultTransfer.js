...
exports.VaultTransferRequest = void 0;
...
const VaultTransferParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.VaultTransferRequest.entries.action.entries), ["type"]);
})();
/**
 * Deposit or withdraw from a vault.
 *
...
function vaultTransfer(config, params, opts) {
    const action = (0, _base_js_1.parse)(VaultTransferParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "vaultTransfer", ...action }, opts);
}
