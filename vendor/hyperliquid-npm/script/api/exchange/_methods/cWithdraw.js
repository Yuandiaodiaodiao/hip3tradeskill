...
exports.CWithdrawTypes = exports.CWithdrawRequest = void 0;
...
const CWithdrawParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.CWithdrawRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "nonce"]);
})();
/** EIP-712 types for the {@linkcode cWithdraw} function. */
exports.CWithdrawTypes = {
...
function cWithdraw(config, params, opts) {
    const action = (0, _base_js_1.parse)(CWithdrawParameters, params);
    return (0, execute_js_1.executeUserSignedAction)(config, { type: "cWithdraw", ...action }, exports.CWithdrawTypes, opts);
}
