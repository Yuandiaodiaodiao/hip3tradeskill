...
const UpdateLeverageParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UpdateLeverageRequest.entries.action.entries), ["type"]);
})();
/**
 * Update cross or isolated leverage on a coin.
 *
...
function updateLeverage(config, params, opts) {
    const action = (0, _base_js_1.parse)(UpdateLeverageParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "updateLeverage", ...action }, opts);
}
