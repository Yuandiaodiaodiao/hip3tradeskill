...
exports.RegisterReferrerRequest = void 0;
exports.registerReferrer = registerReferrer;
 ...
 * @see null
 */
exports.RegisterReferrerRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
...
const RegisterReferrerParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.RegisterReferrerRequest.entries.action.entries), ["type"]);
})();
/**
 * Create a referral code.
 *
...
function registerReferrer(config, params, opts) {
    const action = (0, _base_js_1.parse)(RegisterReferrerParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "registerReferrer", ...action }, opts);
}
