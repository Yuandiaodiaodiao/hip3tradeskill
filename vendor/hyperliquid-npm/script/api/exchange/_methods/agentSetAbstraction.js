...
const AgentSetAbstractionParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.AgentSetAbstractionRequest.entries.action.entries), ["type"]);
})();
/**
 * Set User abstraction mode (method for agent wallet).
 *
...
function agentSetAbstraction(config, params, opts) {
    const action = (0, _base_js_1.parse)(AgentSetAbstractionParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "agentSetAbstraction", ...action }, opts);
}
