...
exports.SubAccountModifyRequest = void 0;
...
const SubAccountModifyParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.SubAccountModifyRequest.entries.action.entries), ["type"]);
})();
/**
 * Modify a sub-account.
 *
...
function subAccountModify(config, params, opts) {
    const action = (0, _base_js_1.parse)(SubAccountModifyParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "subAccountModify", ...action }, opts);
}
