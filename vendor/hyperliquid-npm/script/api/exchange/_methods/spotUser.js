...
exports.SpotUserRequest = void 0;
...
const SpotUserParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.SpotUserRequest.entries.action.entries), ["type"]);
})();
/**
 * Opt Out of Spot Dusting.
 *
...
function spotUser(config, params, opts) {
    const action = (0, _base_js_1.parse)(SpotUserParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "spotUser", ...action }, opts);
}
