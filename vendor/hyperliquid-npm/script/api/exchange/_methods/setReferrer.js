...
exports.SetReferrerRequest = void 0;
...
const SetReferrerParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.SetReferrerRequest.entries.action.entries), ["type"]);
})();
/**
 * Set a referral code.
 *
...
function setReferrer(config, params, opts) {
    const action = (0, _base_js_1.parse)(SetReferrerParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "setReferrer", ...action }, opts);
}
