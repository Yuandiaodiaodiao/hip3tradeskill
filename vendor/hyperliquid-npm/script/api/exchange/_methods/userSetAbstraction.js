...
const UserSetAbstractionParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UserSetAbstractionRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function userSetAbstraction(config, params, opts) {
    const action = (0, _base_js_1.parse)(UserSetAbstractionParameters, params);
    return (0, execute_js_1.executeUserSignedAction)(config, { type: "userSetAbstraction", ...action }, exports.UserSetAbstractionTypes, opts);
}
