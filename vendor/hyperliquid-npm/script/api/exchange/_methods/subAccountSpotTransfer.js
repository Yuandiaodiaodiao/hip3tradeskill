...
exports.SubAccountSpotTransferRequest = void 0;
exports.subAccountSpotTransfer = subAccountSpotTransfer;
 ...
 * @see null
 */
exports.SubAccountSpotTransferRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
...
const SubAccountSpotTransferParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.SubAccountSpotTransferRequest.entries.action.entries), ["type"]);
})();
/**
 * Transfer between sub-accounts (spot).
 *
...
function subAccountSpotTransfer(config, params, opts) {
    const action = (0, _base_js_1.parse)(SubAccountSpotTransferParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "subAccountSpotTransfer", ...action }, opts);
}
