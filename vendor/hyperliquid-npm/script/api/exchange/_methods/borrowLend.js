...
const BorrowLendParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.BorrowLendRequest.entries.action.entries), ["type"]);
})();
/**
 * Borrow or lend assets.
 *
...
function borrowLend(config, params, opts) {
    const action = (0, _base_js_1.parse)(BorrowLendParameters, params);
    return (0, execute_js_1.executeL1Action)(config, { type: "borrowLend", ...action }, opts);
}
