...
const UsdClassTransferParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(UsdClassTransferRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
export function usdClassTransfer(config, params, opts) {
    ...
    return executeUserSignedAction(config, { type: "usdClassTransfer", ...action }, UsdClassTransferTypes, opts);
}
