...
// API Schemas
// ============================================================
import { Address, Percent, UnsignedDecimal, UnsignedInteger } from "../../_schemas.js";
...
const SpotDeployParameters = /* @__PURE__ */ (() => {
    return v.union(SpotDeployRequest.entries.action.options.map((option) => v.omit(option, ["type"])));
})();
/**
 * Deploying HIP-1 and HIP-2 assets.
 *
