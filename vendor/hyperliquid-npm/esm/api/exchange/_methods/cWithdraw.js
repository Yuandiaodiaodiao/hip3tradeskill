...
const CWithdrawParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(CWithdrawRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
export function cWithdraw(config, params, opts) {
    ...
    return executeUserSignedAction(config, { type: "cWithdraw", ...action }, CWithdrawTypes, opts);
}
