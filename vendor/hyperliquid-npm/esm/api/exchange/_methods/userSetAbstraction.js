...
const UserSetAbstractionParameters = /* @__PURE__ */ (() => {
    return v.omit(v.object(UserSetAbstractionRequest.entries.action.entries), ["type", "signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
export function userSetAbstraction(config, params, opts) {
    ...
    return executeUserSignedAction(config, { type: "userSetAbstraction", ...action }, UserSetAbstractionTypes, opts);
}
